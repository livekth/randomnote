; (() => {
    // init
    const button_id = "randomIdeaNote"
    ...
    function addButton() {
        ...
        if (topbar) {
            const button = Object.assign(document.createElement('div'), {
                ...
                title: `Random Idea Note (0/${randomDailyNotesList.length})`,
    ...
    function openRandomDailyNote() {
        ...
        document.getElementById(button_id).title = `Random Idea Note (${dailyNoteIndex}/${randomDailyNotesList.length})` // update queue position in tooltip
